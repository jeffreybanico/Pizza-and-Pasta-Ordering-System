...
?>        
        ...
        <form action="include/order.inc.php" method="post">
            <div class="banner">
            ...
            <div class="btn-block">
                <button type="submit" name="order_confirm_btn">Confirm</button>
                <button type="submit" name="order_cancel_btn">Cancel</button>
            </div>
        </form>
   </div>
